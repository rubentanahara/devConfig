...
vim.keymap.set("n", "<leader>tg", ":FloatermNew --autohide=1 --height=0.9 --width=0.9 --autoclose=2 lazygit<CR>")
vim.keymap.set("n", "<leader>gf", ":FloatermNew --autohide=1 --height=0.9 --width=0.9 --autoclose=2 <CR>")
